...
export class BamlAsyncClient {
  ...
  async Extract_ProblemData(
    ...
    try {
      ...
      return raw.parsed(false) as types.ProblemData
    } catch (error) {
      throw toBamlError(error);
    }
  }
  
  async Extract_animation_data(
      problem: string,
      __baml_options__?: BamlCallOptions
  ): Promise<types.AnimationData> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      const rawEnv = __baml_options__?.env ? { ...process.env, ...__baml_options__.env } : { ...process.env };
      ...
      return raw.parsed(false) as types.AnimationData
    } catch (error) {
      throw toBamlError(error);
    }
  }
...
class BamlStreamClient {
  ...
  ): BamlStream<partial_types.ProblemData, types.ProblemData> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      const rawEnv = __baml_options__?.env ? { ...process.env, ...__baml_options__.env } : { ...process.env };
      ...
      return new BamlStream<partial_types.ProblemData, types.ProblemData>(
        raw,
        (a): partial_types.ProblemData => a,
        (a): types.ProblemData => a,
        this.ctxManager.cloneContext(),
      )
    } catch (error) {
      throw toBamlError(error);
  ...
  Extract_animation_data(
      problem: string,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry, collector?: Collector | Collector[], env?: Record<string, string | undefined> }
  ): BamlStream<partial_types.AnimationData, types.AnimationData> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      const rawEnv = __baml_options__?.env ? { ...process.env, ...__baml_options__.env } : { ...process.env };
      ...
      return new BamlStream<partial_types.AnimationData, types.AnimationData>(
        raw,
        (a): partial_types.AnimationData => a,
        (a): types.AnimationData => a,
        this.ctxManager.cloneContext(),
      )
    } catch (error) {
      throw toBamlError(error);
